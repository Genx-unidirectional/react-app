...
function Skills() {
  return (
    <section
      id="skill"
      className="flex mx-auto  text-white max-w-4xl flex-col lg:h-screen items-center  gap-10  pt-20 scroll-mt-12 px-3 sm:px-4 md:px-6  "
    >
          ...
          <div className=" w-full relative max-w-xs">
            ...
            <div className="relative shadow-xl bg-white border border-gray-800  px-4 py-8 h-full overflow-hidden rounded-2xl flex flex-col justify-end items-start">
              ...
              <p className="font-normal text-base text-slate-500 mb-4 relative z-50">
                I use typescript for reliability and strong type checking which
                is used in big scale application where types are important and
                error are catch while writing the code.
              </p>
